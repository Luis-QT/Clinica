 ...
 * @author Pechito
 */
public class MedicoGeneral extends javax.swing.JFrame {
    ...
    public MedicoGeneral(MedicoEspecialista medicoE) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MedicoGeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        medicoEspecialista.agregarPaciente(new Paciente(0, "LuisRoberto", "LuisRoberto", 6666, true, 21, 98766, 64564, "", 2, "A", "No hay","A09","Los Olivos","Cristiano"));
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MedicoGeneral(null).setVisible(true);
            }
        });
    }

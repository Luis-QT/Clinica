 ...
 * @author LLLL
 */
public class RegistroPacientes extends javax.swing.JDialog {

    /**
     * Creates new form RegistroPacientes
     */
    public RegistroPacientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RegistroPacientes dialog = new RegistroPacientes(new javax.swing.JFrame(), true);

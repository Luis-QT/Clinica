 ...
 * @author LLLL
 */
public class ListaC extends javax.swing.JDialog {

    /**
     * Creates new form MedicoGeneral2
     */
    public ListaC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mantenimiento Cajero");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/iconos/icons8_Paper_Money_50px.png"))); // NOI18N
        ...
        tablaC.setBackground(new java.awt.Color(221, 255, 220));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListaC dialog = new ListaC(new javax.swing.JFrame(), true);

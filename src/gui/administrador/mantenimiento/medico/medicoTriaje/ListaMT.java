 ...
 * @author LLLL
 */
public class ListaMT extends javax.swing.JDialog {

    /**
     * Creates new form MedicoGeneral2
     */
    public ListaMT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mantenimiento Medico Triaje");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/iconos/icons8_Thermometer_50px.png"))); // NOI18N
        ...
        tablaMT.setBackground(new java.awt.Color(221, 255, 220));
        tablaMT.setBorder(javax.swing.BorderFactory.createEtchedBorder());
    ...
    private void tablaMTMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMTMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tablaMTMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaMT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListaMT dialog = new ListaMT(new javax.swing.JFrame(), true);
